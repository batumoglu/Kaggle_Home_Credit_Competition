...
""" Gather data: ApplicationOnly, ApplicationBuroAndPrev, AllData, ApplicationBuro """
train_X, test_X, train_Y = Gather_Data.ApplicationBuro(reduce_mem=False)
...
sub.to_csv('ApplicationBuro_LightGBM_v1.csv', index=False)
